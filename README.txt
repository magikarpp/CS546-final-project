...
1. npm install - In the project folder, enter "npm install" to install all of the dependencies and packages required for the project to run
2. Start MongoDB - make sure it is running on localhost on port 27017
3. Run the project - In the porject folder, enter "npm start" to run the server
